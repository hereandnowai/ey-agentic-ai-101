...
# a conditional edge is an edge that has a condition attached to it.
...
def loans(state):
    return {"reply": "[loan desk] happy to help with your loan."}

def cards(state):
    return {"reply": "[card desk] let's sort out your card."}
...
for msg in ["I want a home loan", "my card was used abroad", "I was double charged"]:
